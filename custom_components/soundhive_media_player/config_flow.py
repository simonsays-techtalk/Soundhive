...
class SoundhiveOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        defaults = {
            ...
            "stt_uri": current_options.get("stt_uri", current_data.get("stt_uri", "http://your-server.domain:10900/inference")),
            "llm_uri": current_options.get("llm_uri", current_data.get("llm_uri", "http://your-server.domain:11434/api/generate")),
            "llm_model": current_options.get("llm_model", current_data.get("llm_model", "llama3.1:8b")),
            "chromadb_url": current_options.get("chromadb_url", current_data.get("chromadb_url", "http://your-server.domain:8001")),
            "wake_keyword": current_options.get("wake_keyword", current_data.get("wake_keyword", "Hey assistant")),
            "sleep_keyword": current_options.get("sleep_keyword", current_data.get("sleep_keyword", "Goodbye")),
            ...
            "stop_keyword": current_options.get("stop_keyword", current_data.get("stop_keyword", "Assistant stop")),
